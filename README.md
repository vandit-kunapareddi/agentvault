...
| `@agentvault/sdk` on npm | **Not yet published.** It's a workspace package inside this monorepo. Today, to use it you self-host this repo |
...
├── packages/
│   ├── sdk/                # @agentvault/sdk — developer-facing client (workspace package)
